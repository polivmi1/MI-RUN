...
/********************   DFun    ********************/
DFun::DFun(Id p1, ListArg *p2, ListStm *p3)
{
  id_ = p1;
  listarg_ = p2;
  liststm_ = p3;
...
/********************   SNewClass    ********************/
SNewClass::SNewClass(Id p1)
{
  id_ = p1;

}

SNewClass::SNewClass(const SNewClass & other)
{
  id_ = other.id_;

}

SNewClass &SNewClass::operator=(const SNewClass & other)
{
  SNewClass tmp(other);
  swap(tmp);
  return *this;
...
void SNewClass::swap(SNewClass & other)
{
  std::swap(id_, other.id_);
...
void SNewClass::accept(Visitor *v)
{
  v->visitSNewClass(this);
}

SNewClass *SNewClass::clone() const
{
  return new SNewClass(*this);
}



/********************   SClassMember    ********************/
SClassMember::SClassMember(Id p1, Id p2, ListExp *p3)
{
  id_1 = p1;
  id_2 = p2;
  listexp_ = p3;
...
SClassMember::SClassMember(const SClassMember & other)
{
  id_1 = other.id_1;
  id_2 = other.id_2;
  listexp_ = other.listexp_->clone();
...
SClassMember &SClassMember::operator=(const SClassMember & other)
{
  SClassMember tmp(other);
  swap(tmp);
  return *this;
}

void SClassMember::swap(SClassMember & other)
{
  std::swap(id_1, other.id_1);
  std::swap(id_2, other.id_2);
  std::swap(listexp_, other.listexp_);
...
SClassMember::~SClassMember()
{
  delete(listexp_);

}

void SClassMember::accept(Visitor *v)
{
  v->visitSClassMember(this);
}
